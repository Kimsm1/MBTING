...
public class MemberController {
	...
	//회원가입
			...
			public String memberJoinAction(HttpServletRequest request,
				...
				String savePath = "C:/image/uploadFile";
				...
				if (!uploadfile.isEmpty()) {
					...
					int result =ms.memberInsert(memberid, memberpwd, membername, membernickname, membergender, memberbirth, memberemail, memberphone, membermbti, memberaddr, agreement, rename ,intro);
				} else {
					int result =ms.memberInsert2(memberid, memberpwd, membername, membernickname, membergender, memberbirth, memberemail, memberphone, membermbti, memberaddr, agreement,intro);
	...
	public String othersProfile(SearchCriteria scri, @RequestParam("midx") int midx, Model model) {		
		...
		MemberVo mv = ms.memberSelectOne2(midx);
