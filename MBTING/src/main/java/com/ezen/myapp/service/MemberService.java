...
public interface MemberService {
	...
	public int memberInsert(String memberid, String memberpwd, String membername, String membernickname, String membergender, int memberbirth, String memberemail, int memberphone, String membermbti, String memberaddr,String agreement, String photo, String intro);	
	
	public int memberInsert2(String memberid, String memberpwd, String membername, String membernickname, String membergender, int memberbirth, String memberemail, int memberphone, String membermbti, String memberaddr,String agreement, String intro);	
