            ...
            <div class="container">
                <header class="infoM7">
                    <div id="container" style="padding-right: 750px;">
                        <button class="button" onClick="location.href='#services1' ">
                            <span>지금 알아보기</span>
                        </button>
                    </div>
                </header>
                    ...
                    <div class="container">
                        <div class="input-form-backgroud row">
                            <div class="input-form col-md-6 mx-auto">
                                <h3 class="mb-3">
                                    <div class="text-center jg">회원정보수정</div>
                                </h3>
                                <form name="frm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea name="intro" class="form-control" style="resize: none; width:330px; height:200px;" id="intro" maxlength="300"><%=mv.getIntro()%></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="custom-select d-block w-100" name="membermbti" required id="pro123">
