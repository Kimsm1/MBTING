...
<html lang="en">
    ...
    <body
            ...
            <div
                ...
                <header class="infoM1">
                    <div id="container" style="padding-right: 750px;">
                        <button class="button1" onClick="location.href='#services1' ">
                            <span>지금 알아보기</span>
                        </button>
                    </div>
                </header>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <header class="infoM2">
                                        <div id="container" style="padding-right: 750px;">
                                            <button class="button" onClick="location.href='<%=request.getContextPath()%>/infoM.do' ">
                                                <span>MBTI 정보</span>
                                            </button>
                                        </div>
                                    </header>
                                ...
                                <div class="carousel-item">
                                    <header class="infoM3">
                                        <div id="container" style="padding-right: 750px;">
                                            <button class="button" onClick="location.href='<%=request.getContextPath()%>/debate.do' ">
                                                <span>TALK</span>
                                            </button>
                                        </div>
                                    </header>
                                ...
                                <div class="carousel-item">
                                    <header class="infoM4">
                                        <div id="container" style="padding-right: 750px;">
                                            <button class="button" onClick="location.href='<%=request.getContextPath()%>/Board2.do' ">
                                                <span>게시판</span>
                                            </button>
                                        </div>
                                    </header>
       ...
       <div class="col-12 col-md-6 right-image">
        ...
        <div class="row first-content-position" data-aos="slide-right" data-aos-duration="600" data-aos-easing="ease-out" style="overflow: hidden;">
          ...
          <div class="col-12 col-md-6 right-image">
                <img src="resources/assets/img/SI/SI4.png" alt="" style="border: 1px solid #ededed; border-radius: 8px;">
  ...
  <div class="row first-content-position" data-aos="slide-right" data-aos-duration="600" data-aos-easing="ease-out" style="overflow: hidden;">
   ...
   <div class="col-12 col-md-6 right-image">
                <img src="resources/assets/img/SI/SI5.png" alt="" style="border: 1px solid #ededed; border-radius: 8px;">
