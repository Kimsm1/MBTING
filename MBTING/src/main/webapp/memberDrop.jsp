...
<html lang="en">
    ...
    <body id="page-top">
        <form name="frm">
            <input
            type="hidden" name="midx" value="<%=mv.getMidx() %>">
            <!-- Navigation-->
            ...
            <div class="page-content">
                <div class="wrapper">
                    ...
                    <p>탈퇴 후에는 아이디
                        <em>(<%=mv.getMemberid()%>)</em>로 다시 가입할 수 없으며 아이디와 데이터는 복구할 수 없습니다.</p>
                    <p>
                        <em>게시판형 서비스에 남아 있는 게시글은 탈퇴 후 삭제할 수 없습니다.</em>
                    </p>
                    <br><br>
                    <div class="out-box3">
                        <table id="table123">
                            <tr>
                                <td>
                                    <h4>
                                        <strong style="font-size:25px;">남기실 말씀</strong>
                                    </h4>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <textarea class="test12333" placeholder="남기실 말씀을 적어주세요." name="outment" style="width: 862px; height: 200px;"></textarea>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="custom-control custom-checkbox">
                        ...
                        <input type="checkbox" class="custom-control-input" name="agreement" id="agreement" value="Y" checked>
                        <label class="custom-control-label" for="agreement">안내 사항을 모두 확인하였으며, 이에 동의합니다.</label>
                    </div>
                ...
                <div class="col-12" style="padding: 0; margin-top: 24px; padding-left: 0px; ">
                    <h3>
                        ...
                        <h6>
                            ...
                            <h6>
                                전북 전주시 덕진구 백제대로 572 5층<br/></h6>
                            <h6>
                                이메일 : qwerr123@123123<br/></h6>
                            <h6>
                                제휴문의 : qwert123@12312</h6>
                            <br/>
                            <br/>
                            <div class="col-12 customer-call">
                                <h3>엠비팅 고객문의 연락처
                                    <a href="tel:1234-5678" style="color:#004080;">1234-5678</a>
                                </h3>
                                <br/>
                                <br/>
                            </div>
