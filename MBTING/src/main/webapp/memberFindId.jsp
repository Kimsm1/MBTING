...
<% MemberVo mv = (MemberVo)request.getAttribute("mv");%> 
    <head>
        ...
        function check(){
			...
			fm.action="<%=request.getContextPath()%>/memberFindIdAction.do";
			fm.method="post";
			fm.submit();	
			return;
		}
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h3 text-gray-900 mb-4 jg">아이디 찾기</h1>
                                        <h5 class="h6 text-gray-900 mb-4 jg">회원님의 아이디를 찾아드립니다</h5>
                                    </div>
                                    <form name="frm" >
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control"
                                                name="memberemail" placeholder="회원 정보에 기입한 이메일">
                                       		 </div>
                                       ...
                                       <div class="row">
                                        ...
                                        <br>
                                        <a class="btn btn-primary btn-user btn-block" onClick="check(); return false;" style="width:auto; margin:auto; display:block";>확인</a>
                                    	</form>
                                   	 <hr>
                                    <div class="text-center">
