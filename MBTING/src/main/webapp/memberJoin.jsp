...
<html lang="en">
	 <head>
        ...
        $(document).ready(function(){       	
        	...
        	$("#memberIdCheck").click(function(){   // 아이디 중복체크를 눌렀을때
        	...
        	$("#memberEmailCheck").click(function(){   // 이메일중복체크를 눌었을때
        	...
        	$("#memberNickCheck").click(function(){   // 닉네임중복체크를 눌렀을때
							           ...
							           <div class="mb-3">       
							            ...
							            <div class="mb-3">
							              	<label for="root">MBTI</label>
							             		 <select class="custom-select d-block w-100" name="membermbti" required id="join123">
									              ...
									              <textarea name="intro"  class="form-control" style="resize: none; width:650px; height:200px;" id="intro" placeholder="자기소개를 입력해주세요" maxlength="300">자기소개가 등록되지 않았습니다.</textarea>
