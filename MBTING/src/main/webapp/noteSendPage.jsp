  ...
  <h2>	쪽지쓰기</h2>
        ...
        <form name="fm">
            <table id="table1" style="width:800px;  ">
                <input type="hidden" name="send_nick" value="${sessionScope.membernickname }">
                    <tr>
                        ...
                        <td><input type="text" name="recv_nick" value="${mv.membernickname }" style="width:650px;" readonly="readonly"/></td>
                    </tr>
            ...
            <table id="table1" style="width:800px;">
                <tr>
                    <td colspan="3">
                        <button class="btn" onClick="check();return false;">보내기</button>
                    </td>
                </tr>
            </table>
