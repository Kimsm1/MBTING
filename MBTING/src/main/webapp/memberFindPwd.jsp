...
<% MemberVo mv = (MemberVo)request.getAttribute("mv");%> 
    <head>
        ...
        function check(){
			...
			fm.action="<%=request.getContextPath()%>/memberFindPwdAction.do";
			fm.method="post";
			fm.submit();	
			return;
		}
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h3 text-gray-900 mb-4 jg">비밀번호 찾기</h1>
                                        <h5 class="h6 text-gray-900 mb-4 jg">회원님의 비밀번호를 찾아드립니다</h5>
                                    </div>
                                    <form name="frm" >
