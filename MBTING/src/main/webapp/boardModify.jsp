                            ...
                            <form name="frm">
                                <table class="type09" style="width:1200px ">
                                    ...
                                    <tr>
                                        <td>내용</td>
                                        <td>
                                            <textarea style="resize: none;" name="contents" cols="50" rows="5" id="modify124"><%=bv.getContents()%></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>비밀번호</td>
                                        <td><input type="password" name="pwd" id="modify123"></td>
                                    </tr>
                                    <tr style="background-color:#f9f9f9">
                                        <td colspan="2">
