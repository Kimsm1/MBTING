	    ...
	    <form name="fm" >
	    	...
	    	<input type="hidden" name="send_nick" value="${sessionScope.membernickname }" >
	  		  ...
	  		  <td style="width:100px;  ">받는사람 :</td>
	   		  <td><input type = "text" name="recv_nick" id="reply123" value ="${nv.send_nick}" style="width:350px;" readonly/></td>
		    </tr>  
	 	    <tr style=" height:500px;  ">
	 		  <td colspan=2><textarea class=test12333 id="content"  Placeholder="남기실 말씀을 적어주세요." name="content"  style="width: 794px; height: 500px;"></textarea>
	   						 <div id="test_cnt">(0 / 300)</div></td>
	  		  </tr>
	   	 </table>
	    </form>
