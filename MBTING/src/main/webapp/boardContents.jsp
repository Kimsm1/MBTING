					...
					success : function(data){
						...
						//alert(s_nickname);
							$(data).each(function(){
								...
								//}
							str = "<tr><td width=1050>"+this.membernickname+"<br>"+this.c_contents+"<hr>"+"</td>"									
									+"<td width=50>";
															
									if (s_nickname==this.membernickname){
							str1 =		"<input type='button'class='btn1' name='del' id='del"+this.cidx+"' onclick='$.check("+this.cidx+");' value='삭제'>";
									}else{
							str1 =	"";
										}					
    ...
    <body id="page-top">
   	 ...
   	 <div id="container">
            ...
            <div class="div_inner">
				...
				<td style="width:150px;">&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/resources/assets/img/005.png" alt="..." id="img3">&nbsp;&nbsp;<%=bv.getHit()%></td>
				...
				<table  style="width:1200px;text-align:right" id="table5">
				<tr>
				<td >
				
				<button class="btn50" onClick="document.location.href='<%=request.getContextPath()%>/board/boardModify.do?bidx=<%=bv.getBidx()%>' ">수정</button>
				<button class="btn50" onClick="document.location.href='<%=request.getContextPath()%>/board/boardDelete.do?bidx=<%=bv.getBidx()%>' ">삭제</button>
				<button class="btn50" onClick="document.location.href='<%=request.getContextPath()%>/boardList.do' " >목록</button>
				</td>				
				</tr>
				...
				<img src="<%=request.getContextPath()%>/resources/assets/img/005.png" alt="..." id = "hit" name="hit" />
				
				
				</div>
				<br><br><br><br>
				
				  <h2 style="padding-left: 590px;"> 댓글 </h2>
				<table class="type09" style="width:1200px; ">
				<tr style=background-color:#f9f9f9 >
				<td colspan=2><input type="hidden" name="membernickname" id="membernickname">
				<textarea style="resize: none;" name="c_contents"  id="c_contents"  cols=128 rows=2 > </textarea></td>
				
				<td><input type="button" class="btn"  name="save" id="save" value="등록"></td>
				</tr>
				<tr>
				<td colspan=3 class="jg" style="padding-left: 550px;  "><br></td>
				</tr>
				</table>
				...
				<table class="type11" style="width:1200px;"><tr><td>
